...
function getViteConfiguration(config, options, directoryFormat, enableManifestTransform) {
  ...
  if (options.pwaAssets) {
    options.pwaAssets.integration = {
      ...
      publicDir: node_url.fileURLToPath(config.publicDir),
      outDir: node_url.fileURLToPath(config.outDir)
    };
  }
